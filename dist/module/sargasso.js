...
/** Built-in value references. */ var Buffer = moduleExports ? $7433d465c46f159c$exports.Buffer : undefined;
...
var $7433d465c46f159c$exports = {};
var $4cf493ad068b6c35$exports = {};
...
$4cf493ad068b6c35$exports = $4cf493ad068b6c35$var$freeGlobal;


/** Detect free variable `self`. */ var $7433d465c46f159c$var$freeSelf = typeof self == 'object' && self && self.Object === Object && self;
/** Used as a reference to the global object. */ var $7433d465c46f159c$var$root = $4cf493ad068b6c35$exports || $7433d465c46f159c$var$freeSelf || Function('return this')();
$7433d465c46f159c$exports = $7433d465c46f159c$var$root;
...
/** Detect free variable `module`. */ var freeModule = freeExports && "object" == 'object' && module && !module.nodeType && module;
/** Detect the popular CommonJS extension `module.exports`. */ var moduleExports = freeModule && freeModule.exports === freeExports;
/** Detect free variable `process` from Node.js. */ var freeProcess = moduleExports && $4cf493ad068b6c35$exports.process;
...
/** Built-in value references. */ var $ab1e9e4db6409106$var$Symbol = $7433d465c46f159c$exports.Symbol;
...
const $fc459ab49b48f320$var$validators = {
};
const $fc459ab49b48f320$export$636d763ed7be9e97 = (name, fn)=>{
    $fc459ab49b48f320$var$validators[name] = fn;
};
$fc459ab49b48f320$export$636d763ed7be9e97('isDefined', (arg)=>{
    return arg !== undefined;
});
$fc459ab49b48f320$export$636d763ed7be9e97('isUnDefined', (arg)=>{
    return arg === undefined;
});
$fc459ab49b48f320$export$636d763ed7be9e97('isNull', (arg)=>{
    return arg === null;
});
$fc459ab49b48f320$export$636d763ed7be9e97('isElement', (arg)=>{
    return arg && (arg instanceof Element || arg instanceof Window);
});
$fc459ab49b48f320$export$636d763ed7be9e97('isEventTarget', (arg)=>{
    return arg && arg instanceof EventTarget;
});
$fc459ab49b48f320$export$636d763ed7be9e97('isString', (arg)=>{
    return arg && (typeof arg === 'string' || arg instanceof String);
});
$fc459ab49b48f320$export$636d763ed7be9e97('isArray', (arg)=>{
    return arg && arg instanceof Array;
});
$fc459ab49b48f320$export$636d763ed7be9e97('notEmpty', (arg)=>{
    return arg instanceof Array ? arg.length !== 0 : arg !== '';
});
$fc459ab49b48f320$export$636d763ed7be9e97('isEmpty', (arg)=>{
    return arg === undefined || !arg || (arg instanceof Array ? arg.length === 0 : arg === '');
});
$fc459ab49b48f320$export$636d763ed7be9e97('isObject', (arg)=>{
    return arg && arg instanceof Object;
});
$fc459ab49b48f320$export$636d763ed7be9e97('isFunction', (arg)=>{
...
// ['this','and',['either','or']]
const $fc459ab49b48f320$export$a22775fa5e2eebd9 = (param, arg, tests)=>{
    // console.log(param, arg)
    const allOf = tests.map((test)=>{
        if (test instanceof Array) {
            const anyOf = test.map((orTest)=>{
                return $fc459ab49b48f320$var$validators[orTest] && $fc459ab49b48f320$var$validators[orTest](arg);
            });
            return anyOf.indexOf(true) !== -1;
        } else return $fc459ab49b48f320$var$validators[test] && $fc459ab49b48f320$var$validators[test](arg);
    });
    if (allOf.indexOf(false) !== -1) throw new Error('call to ' + param + ' invalid value: ' + arg + ' ' + tests, 0 + allOf);
};


const $32a536c4ebfbd5e9$var$elementMetaData = new WeakMap();
const $32a536c4ebfbd5e9$var$hasClass = (element, cssClass)=>{
    $fc459ab49b48f320$export$a22775fa5e2eebd9('hasClass element', element, [
        'isDefined',
        'isElement'
    ]);
    $fc459ab49b48f320$export$a22775fa5e2eebd9('hasClass cssClass', cssClass, [
        'isDefined',
        'notEmpty',
        'isString'
    ]);
...
const $32a536c4ebfbd5e9$var$addClass = (element, addClasses)=>{
    $fc459ab49b48f320$export$a22775fa5e2eebd9('addClass element', element, [
        'isDefined',
        'isElement'
    ]);
    $fc459ab49b48f320$export$a22775fa5e2eebd9('addClass addClasses', addClasses, [
        'isDefined',
        'notEmpty',
        [
            'isString',
...
// a list delimited by comma or space 'class1 class3 class4'
// an array ['class1','class2']
const $32a536c4ebfbd5e9$var$removeClass = (element, removeClasses)=>{
    $fc459ab49b48f320$export$a22775fa5e2eebd9('removeClass element', element, [
        'isDefined',
        'isElement'
    ]);
    $fc459ab49b48f320$export$a22775fa5e2eebd9('removeClass removeClasses', removeClasses, [
        'isDefined',
        'notEmpty',
        [
            'isString',
...
const $32a536c4ebfbd5e9$var$isVisible = (element)=>{
    $fc459ab49b48f320$export$a22775fa5e2eebd9('isVisible element', element, [
        'isDefined',
        'isElement'
    ]);
    return !!(element.offsetWidth || element.offsetHeight || element.getClientRects().length);
};
const $32a536c4ebfbd5e9$var$inViewPort = (element, container = window)=>{
    $fc459ab49b48f320$export$a22775fa5e2eebd9('inViewPort element', element, [
        'isDefined',
        'isElement'
    ]);
    const rect = element.getBoundingClientRect();
    const visible = $32a536c4ebfbd5e9$var$isVisible(element);
...
*/ const $32a536c4ebfbd5e9$var$css = (element, css)=>{
    $fc459ab49b48f320$export$a22775fa5e2eebd9('css element', element, [
        'isDefined',
        'isElement'
    ]);
    $fc459ab49b48f320$export$a22775fa5e2eebd9('css css', css, [
        'isDefined',
        [
            'isObject'
        ]
...
const $32a536c4ebfbd5e9$var$setMetaData = (element, k, v)=>{
    $fc459ab49b48f320$export$a22775fa5e2eebd9('setMetaData element', element, [
        'isDefined',
        'isElement'
    ]);
    $fc459ab49b48f320$export$a22775fa5e2eebd9('setMetaData k', k, [
        'isDefined',
        'isString'
    ]);
    $fc459ab49b48f320$export$a22775fa5e2eebd9('setMetaData v', v, [
        [
            'isUnDefined',
            'isNull',
            'isString',
    ...
    const data = $32a536c4ebfbd5e9$var$elementMetaData.get(element) || {
    };
    if (v) data[k] = v;
    else delete data[k];
    $32a536c4ebfbd5e9$var$elementMetaData.set(element, data);
};
const $32a536c4ebfbd5e9$var$getMetaData = (element, k)=>{
    $fc459ab49b48f320$export$a22775fa5e2eebd9('getMetaData element', element, [
        'isDefined',
        'isElement'
    ]);
    $fc459ab49b48f320$export$a22775fa5e2eebd9('getMetaData k', k, [
        'isDefined',
        'isString'
    ]);
    const data = $32a536c4ebfbd5e9$var$elementMetaData.get(element) || {
...
const $32a536c4ebfbd5e9$var$on = function(uid, container, events, selector, fn, options, once) {
    ...
    $fc459ab49b48f320$export$a22775fa5e2eebd9('on uid', uid, [
        'isDefined',
        'notEmpty'
    ]);
    $fc459ab49b48f320$export$a22775fa5e2eebd9('on container', container, [
        'isDefined',
        'isEventTarget'
    ]);
    $fc459ab49b48f320$export$a22775fa5e2eebd9('on events', events, [
        'isDefined',
        'isString'
    ]);
    $fc459ab49b48f320$export$a22775fa5e2eebd9('on fn', fn, [
        'isDefined',
        'isFunction'
    ]);
    $fc459ab49b48f320$export$a22775fa5e2eebd9('on selector', selector, [
        [
            'isEmpty',
            'isString'
        ]
    ...
    if ($32a536c4ebfbd5e9$var$getMetaData(container, k)) {
        console.error('Error: Sargasso utils.on: duplicate event handler specification. %o %s', container, k);
        return;
    }
    const handler = (e)=>{
        if (once) $32a536c4ebfbd5e9$var$off(uid, container, events, selector);
        if (!selector) fn(e);
    ...
    $32a536c4ebfbd5e9$var$setMetaData(container, k, data);
    events.split(/[\s,]+/).forEach((evt)=>{
        container.addEventListener(evt.trim(), data.fn, data.options);
    });
};
const $32a536c4ebfbd5e9$var$off = function(uid, container, events, selector) {
    $fc459ab49b48f320$export$a22775fa5e2eebd9('off uid', uid, [
        'isDefined',
        'notEmpty'
    ]);
    $fc459ab49b48f320$export$a22775fa5e2eebd9('off container', container, [
        'isDefined',
        'isEventTarget'
    ]);
    $fc459ab49b48f320$export$a22775fa5e2eebd9('off events', events, [
        'isDefined',
        'isString'
    ]);
    $fc459ab49b48f320$export$a22775fa5e2eebd9('off selector', selector, [
        [
            'isEmpty',
            'isString'
        ]
    ...
    const k = 'on:' + uid + '-' + events + '-' + selector;
    const data = $32a536c4ebfbd5e9$var$getMetaData(container, k);
    if (data) {
        events.split(/[\s,]+/).forEach((evt)=>{
            container.removeEventListener(evt.trim(), data.fn, data.options);
        });
        $32a536c4ebfbd5e9$var$setMetaData(container, k);
    }
};
// remove all (on,once) event handlers for element
const $32a536c4ebfbd5e9$var$offAll = function(container) {
    $fc459ab49b48f320$export$a22775fa5e2eebd9('offAll container', container, [
        'isDefined',
        'isEventTarget'
    ]);
    const data = $32a536c4ebfbd5e9$var$elementMetaData.get(container) || {
    };
    const handlers = [];
    for(const k in data){
    ...
    handlers.forEach((k)=>{
        $32a536c4ebfbd5e9$var$off(data[k].uid, container, data[k].events, data[k].selector);
    });
};
const $32a536c4ebfbd5e9$var$once = function(uid, container, events, selector, fn, options) {
    if (typeof selector === 'function') {
        options = fn;
        fn = selector;
        selector = undefined;
    }
    $32a536c4ebfbd5e9$var$on(uid, container, events, selector, fn, options, true);
};
const $32a536c4ebfbd5e9$export$6f53260fffa88f1c = {
    hasClass: $32a536c4ebfbd5e9$var$hasClass,
    addClass: $32a536c4ebfbd5e9$var$addClass,
    removeClass: $32a536c4ebfbd5e9$var$removeClass,
    isVisible: $32a536c4ebfbd5e9$var$isVisible,
    inViewPort: $32a536c4ebfbd5e9$var$inViewPort,
    setCSS: $32a536c4ebfbd5e9$var$css,
    setMetaData: $32a536c4ebfbd5e9$var$setMetaData,
    getMetaData: $32a536c4ebfbd5e9$var$getMetaData,
    on: $32a536c4ebfbd5e9$var$on,
    off: $32a536c4ebfbd5e9$var$off,
    once: $32a536c4ebfbd5e9$var$once,
    offAll: $32a536c4ebfbd5e9$var$offAll
};
 ...
 */ var $841dde3de9d388fa$var$now = function() {
    return $7433d465c46f159c$exports.Date.now();
};
...
/** Used to detect overreaching core-js shims. */ var $91ce128a81f48807$var$coreJsData = $7433d465c46f159c$exports["__core-js_shared__"];
...
/* Built-in method references that are verified to be native. */ var $05957ea21bb1a9ad$var$Map = $991ed471436b8bad$exports($7433d465c46f159c$exports, 'Map');
...
/** Built-in value references. */ var $62dea8796f76e723$var$Uint8Array = $7433d465c46f159c$exports.Uint8Array;
...
/* Built-in method references that are verified to be native. */ var $2224cfb253c94a88$var$DataView = $991ed471436b8bad$exports($7433d465c46f159c$exports, 'DataView');
...
/* Built-in method references that are verified to be native. */ var $9dae146f32121137$var$Promise = $991ed471436b8bad$exports($7433d465c46f159c$exports, 'Promise');
...
/* Built-in method references that are verified to be native. */ var $463b94df14432c06$var$Set = $991ed471436b8bad$exports($7433d465c46f159c$exports, 'Set');
...
/* Built-in method references that are verified to be native. */ var $5778ee132289aa29$var$WeakMap = $991ed471436b8bad$exports($7433d465c46f159c$exports, 'WeakMap');
...
/*
	...
	*/ const $a4ae693d0e2d1ecb$var$registeredObservables = {
};
const $a4ae693d0e2d1ecb$export$7ec259ba0528fb23 = (id)=>{
    return $a4ae693d0e2d1ecb$var$registeredObservables[id];
};
const $a4ae693d0e2d1ecb$var$buildProxy = (self)=>{
    return {
        get (target, property) {
            const val = Reflect.get(target, property);
            if (val && typeof val === 'object') return new Proxy(val, $a4ae693d0e2d1ecb$var$buildProxy(self));
            return val;
        },
...
/*
	...
	*/ class $a4ae693d0e2d1ecb$export$b176171395436676 {
    /*
		...
		*/ constructor(id, data = {
        ...
        this.id = id;
        if ($a4ae693d0e2d1ecb$var$registeredObservables[this.id]) throw new Error('ObservableObject ' + id + ' already exists.');
        this.bound = {
        } // watchers to sync on value change
        ;
        this.data = new Proxy(data, $a4ae693d0e2d1ecb$var$buildProxy(this));
        this.options = options;
        $a4ae693d0e2d1ecb$var$registeredObservables[this.id] = this;
    }
    /*
		@function destroy - remove all bindings
		*/ destroy() {
        delete $a4ae693d0e2d1ecb$var$registeredObservables[this.id];
        delete this.data;
    ...
    /*
		...
		*/ sync(property) {
        Object.keys(this.bound['*'] || {
        }).forEach((k)=>{
            this.bound['*'][k](this.id, property, this.get(property));
        });
        Object.keys(this.bound[property] || {
        }).forEach((k)=>{
...
let $b46dd4a3ae89fa2b$export$77e1d49fdb880d27;
let $b46dd4a3ae89fa2b$export$c7320459fd5267c0;
let $b46dd4a3ae89fa2b$export$497098c8185e6e33;
let $b46dd4a3ae89fa2b$export$296acd8d6f329fa3;
let $b46dd4a3ae89fa2b$export$fa28dfcc49831a91;
let $b46dd4a3ae89fa2b$export$788f7857dc8c77f5;
class $b46dd4a3ae89fa2b$var$ObserverSubscriptionManager {
    constructor(options){
        this.options = options;
        this.observers = [];
...
class $b46dd4a3ae89fa2b$export$d36264ac4e7cee7d extends $b46dd4a3ae89fa2b$var$ObserverSubscriptionManager {
    constructor(options = {
    }){
        super(options);
...
class $b46dd4a3ae89fa2b$var$ScrollWatcher extends $b46dd4a3ae89fa2b$var$ObserverSubscriptionManager {
    constructor(options = {
    }){
        super(options);
    ...
    wakeup() {
        super.wakeup();
        $32a536c4ebfbd5e9$export$6f53260fffa88f1c.on('theScrollWatcher', this.scrollElement, 'scroll', ()=>{
            this.trigger();
        });
    }
    sleep() {
        super.sleep();
        $32a536c4ebfbd5e9$export$6f53260fffa88f1c.off('theScrollWatcher', this.scrollElement, 'scroll');
    }
    inViewPort(element) {
        return $32a536c4ebfbd5e9$export$6f53260fffa88f1c.inViewPort(element, this.scrollElement);
    }
    watchScroll() {
...
class $b46dd4a3ae89fa2b$var$ResizeWatcher extends $b46dd4a3ae89fa2b$var$ObserverSubscriptionManager {
    constructor(options){
        super(options);
...
class $b46dd4a3ae89fa2b$var$OrientationWatcher extends $b46dd4a3ae89fa2b$var$ObserverSubscriptionManager {
    constructor(options){
        super(options);
        if ('onorientationchange' in window) $32a536c4ebfbd5e9$export$6f53260fffa88f1c.addClass(document.body, 'have-orientation');
        else $32a536c4ebfbd5e9$export$6f53260fffa88f1c.addClass(document.body, 'no-orientation');
        this.debounce = (/*@__PURE__*/$parcel$interopDefault($883871a813e4aea5$exports))(()=>{
...
class $b46dd4a3ae89fa2b$var$WorkerWatcher extends $b46dd4a3ae89fa2b$var$ObserverSubscriptionManager {
    constructor(options){
        super(options);
        this.workers = {
        };
...
class $b46dd4a3ae89fa2b$var$ObservableObjectWatcher extends $b46dd4a3ae89fa2b$var$ObserverSubscriptionManager {
    constructor(options){
        super(options);
    ...
    observableStart(id, data) {
        const foundObservable = $a4ae693d0e2d1ecb$export$7ec259ba0528fb23(id);
        ...
        if (!this.registeredObservableObjects[id]) {
            if (foundObservable) this.registeredObservableObjects[id] = {
                ...
                id: id,
                observable: new $a4ae693d0e2d1ecb$export$b176171395436676(id, data),
                observers: [],
                managed: true
            };
...
$b46dd4a3ae89fa2b$export$77e1d49fdb880d27 = new $b46dd4a3ae89fa2b$export$d36264ac4e7cee7d();
$b46dd4a3ae89fa2b$export$c7320459fd5267c0 = new $b46dd4a3ae89fa2b$var$ScrollWatcher();
$b46dd4a3ae89fa2b$export$497098c8185e6e33 = new $b46dd4a3ae89fa2b$var$ResizeWatcher();
$b46dd4a3ae89fa2b$export$296acd8d6f329fa3 = new $b46dd4a3ae89fa2b$var$OrientationWatcher();
$b46dd4a3ae89fa2b$export$fa28dfcc49831a91 = new $b46dd4a3ae89fa2b$var$WorkerWatcher();
$b46dd4a3ae89fa2b$export$788f7857dc8c77f5 = new $b46dd4a3ae89fa2b$var$ObservableObjectWatcher();
...
let $69e1433b5e49874b$var$unique = 0 // unique IDs for controllers
;
const $69e1433b5e49874b$export$85e745b96b6487a7 = [] // instantiated controllers
;
const $69e1433b5e49874b$var$supportsCustomElements = 'customElements' in window// browser supports custom elements
;
const $69e1433b5e49874b$export$ac297e650eeb1e78 = {
};
/*
	...
	*/ const $69e1433b5e49874b$export$22044c20eef36040 = (className, object)=>{
    if ($69e1433b5e49874b$export$ac297e650eeb1e78[className]) throw new Error('Sargasso class ' + className + ' is already registered.');
    $69e1433b5e49874b$export$ac297e650eeb1e78[className] = object;
    if ($69e1433b5e49874b$var$supportsCustomElements) {
        /*
		...
		*/ const customElementClassFactory = `
        ...
        const fn = new Function('registeredClasses', customElementClassFactory)($69e1433b5e49874b$export$ac297e650eeb1e78);
...
const $69e1433b5e49874b$var$eventNames = [
    'DOMChanged',
    'didScroll',
    'didResize',
    'didBreakpoint',
...
/*
	...
	*/ class $69e1433b5e49874b$export$d7944a94c1afb262 {
    constructor(element, options = {
    }){
        $fc459ab49b48f320$export$a22775fa5e2eebd9('Sargasso constructor element', element, [
            'isDefined',
            'isElement'
        ]);
        $fc459ab49b48f320$export$a22775fa5e2eebd9('Sargasso constructor options', options, [
            'isDefined',
            [
                'isObject'
            ]
        ]);
        this.uid = ++$69e1433b5e49874b$var$unique;
    ...
    /*
		...
		*/ start() {
        ...
        $69e1433b5e49874b$export$85e745b96b6487a7.push(this);
        // if using shadow DOM, build a DOMWatcher to observe changes
        if (this._shadowDOM) {
            if (!this._shadowDOMWatcher) this._shadowDOMWatcher = new $b46dd4a3ae89fa2b$export$d36264ac4e7cee7d({
                shadowDOM: this._shadowRoot
            });
            this._shadowDOMWatcher.subscribe(this);
        }
        // subscribe to desired event services
        if (this.options.watchDOM) $b46dd4a3ae89fa2b$export$77e1d49fdb880d27.subscribe(this);
        if (this.options.watchScroll || this.options.watchViewport) $b46dd4a3ae89fa2b$export$c7320459fd5267c0.subscribe(this);
        if (this.options.watchResize || this.options.watchViewport) $b46dd4a3ae89fa2b$export$497098c8185e6e33.subscribe(this);
        if (this.options.watchOrientation || this.options.watchViewport) $b46dd4a3ae89fa2b$export$296acd8d6f329fa3.subscribe(this);
        /*
		...
		*/ this.elementListener = (e)=>{
            if (e.detail && e.detail.sargassoEvent && $69e1433b5e49874b$var$eventNames.indexOf(e.detail.sargassoEvent) !== -1) this[e.detail.sargassoEvent].apply(this, e.detail.sargassoEventOptions || []);
    ...
    /*
		...
		*/ sleep() {
        ...
        if (this.options.watchDOM) $b46dd4a3ae89fa2b$export$77e1d49fdb880d27.unSubscribe(this);
        if (this.options.watchScroll || this.options.watchViewport) $b46dd4a3ae89fa2b$export$c7320459fd5267c0.unSubscribe(this);
        if (this.options.watchResize || this.options.watchViewport) $b46dd4a3ae89fa2b$export$497098c8185e6e33.unSubscribe(this);
        if (this.options.watchOrientation || this.options.watchViewport) $b46dd4a3ae89fa2b$export$296acd8d6f329fa3.unSubscribe(this);
        this.element.removeEventListener('sargasso', this.elementListener);
        $32a536c4ebfbd5e9$export$6f53260fffa88f1c.offAll(this.element) // remove all dangling event listeners created with on/once
        ;
        this._started = false;
    }
    /**************************************************************
	...
	*****************************************************/ /*
		...
		*/ setMetaData(k, v) {
        $32a536c4ebfbd5e9$export$6f53260fffa88f1c.setMetaData(this.element, k, v);
    }
    /*
		...
		*/ getMetaData(k) {
        return $32a536c4ebfbd5e9$export$6f53260fffa88f1c.getMetaData(this.element, k);
    }
    /*
		...
		*/ on(evt, selector, fn, options) {
        $32a536c4ebfbd5e9$export$6f53260fffa88f1c.on(this.constructor.name + '-' + this.uid, this.element, evt, selector, fn, options);
    }
    /*
		...
		*/ off(evt, selector) {
        $32a536c4ebfbd5e9$export$6f53260fffa88f1c.off(this.constructor.name + '-' + this.uid, this.element, evt, selector);
    }
    /*
		...
		*/ once(evt, selector, fn, options) {
        $32a536c4ebfbd5e9$export$6f53260fffa88f1c.once(this.constructor.name + '-' + this.uid, this.element, evt, selector, fn, options);
    }
    /*
		...
		*/ notifyAll(event, params) {
        if ($69e1433b5e49874b$var$eventNames.indexOf(event) === -1) throw new Error('invalid event name ' + event);
        for(let i = 0; i < $69e1433b5e49874b$export$85e745b96b6487a7.length; i++){
            const peer = $69e1433b5e49874b$export$85e745b96b6487a7[i];
	...
	***********************************************************************/ hasClass(cssClass) {
        return $32a536c4ebfbd5e9$export$6f53260fffa88f1c.hasClass(this.element, cssClass);
    }
    addClass(cssClasses) {
        $32a536c4ebfbd5e9$export$6f53260fffa88f1c.addClass(this.element, cssClasses);
    }
    removeClass(cssClasses) {
        $32a536c4ebfbd5e9$export$6f53260fffa88f1c.removeClass(this.element, cssClasses);
    }
    setCSS(cssObject) {
        $32a536c4ebfbd5e9$export$6f53260fffa88f1c.setCSS(this.element, cssObject);
    }
    isVisible() {
        return $32a536c4ebfbd5e9$export$6f53260fffa88f1c.isVisible(this.element);
    }
    /*
		...
		*/ workerStart(id, codeOrURL) {
        this._workers[id] = $b46dd4a3ae89fa2b$export$fa28dfcc49831a91.registerWorker(id, codeOrURL);
        $b46dd4a3ae89fa2b$export$fa28dfcc49831a91.subscribe(this, id);
	...
	*************************************************/ getObservable(id) {
    ...
    observableStart(id, data) {
        $b46dd4a3ae89fa2b$export$788f7857dc8c77f5.subscribe(this, id, data);
        this._observables[id] = $b46dd4a3ae89fa2b$export$788f7857dc8c77f5.getObservable(id);
        return this._observables[id];
    }
    observableStop(id) {
        if (this._observables[id]) {
            $b46dd4a3ae89fa2b$export$788f7857dc8c77f5.unSubscribe(this, id);
	...
	*************************************************/ /*
    ...
    /*
		...
		*/ _stopWorker(id) {
        if (this._workers[id]) {
            $b46dd4a3ae89fa2b$export$fa28dfcc49831a91.unSubscribe(this, id);
    ...
    /*
		...
		*/ destroy() {
        ...
        this.element = null;
        if ($69e1433b5e49874b$export$85e745b96b6487a7.indexOf(this) !== -1) $69e1433b5e49874b$export$85e745b96b6487a7.splice($69e1433b5e49874b$export$85e745b96b6487a7.indexOf(this), 1);
    }
    /****************************************************
	...
	*****************************************************/ /*
		...
		*/ watchDOM(root) {
        ...
        // controllers, etc.
        $b46dd4a3ae89fa2b$export$77e1d49fdb880d27.observeDOM(this._shadowRoot);
    ...
    /*
		...
		*/ inViewport() {
        if ($b46dd4a3ae89fa2b$export$c7320459fd5267c0.inViewPort(this.element)) {
...
$69e1433b5e49874b$export$22044c20eef36040('Sargasso', $69e1433b5e49874b$export$d7944a94c1afb262);
...
class $2eeaa5835dffe282$export$10307b0c33312dbb extends $69e1433b5e49874b$export$d7944a94c1afb262 {
    constructor(element, options = {
    }){
    ...
    lazyHandler(root = document) {
        ...
        for(let i = 0; i < els.length; i++){
            const element = els[i];
            if ($b46dd4a3ae89fa2b$export$c7320459fd5267c0.inViewPort(element)) {
                const cls = element.getAttribute('data-lazy-sargasso-class').split(/\s*,\s*/);
                for(let j = 0; j < cls.length; j++){
                    const thing = new $69e1433b5e49874b$export$ac297e650eeb1e78[cls[j]](els[i]);
                    thing.start();
                }
...
$69e1433b5e49874b$export$22044c20eef36040('LazyInstantiate', $2eeaa5835dffe282$export$10307b0c33312dbb);


class $ccd81a49f0a7581e$export$26b75d03ac531c24 extends $69e1433b5e49874b$export$d7944a94c1afb262 {
    constructor(element, options = {
    }){
        super(element, {
            watchDOM: true,
        ...
        this.lazy = new $2eeaa5835dffe282$export$10307b0c33312dbb(element, options);
    }
    start() {
        this.lazy.start();
        super.start();
    ...
    instantiate(element) {
        ...
        for(let i = 0; i < cls.length; i++)try {
            const thing = new $69e1433b5e49874b$export$ac297e650eeb1e78[cls[i]](element);
            thing.start();
        } catch (e) {
            console.log('error instantiating ' + cls[i], e, $69e1433b5e49874b$export$ac297e650eeb1e78);
        }
    ...
    doIt(root = document.body) {
        ...
        const toCleanup = [];
        for(let i = 0; i < $69e1433b5e49874b$export$85e745b96b6487a7.length; i++)if (!$69e1433b5e49874b$export$85e745b96b6487a7[i].options.immortal && !$69e1433b5e49874b$export$85e745b96b6487a7[i].options.isCustomElement && !document.body.contains($69e1433b5e49874b$export$85e745b96b6487a7[i].element)) toCleanup.push($69e1433b5e49874b$export$85e745b96b6487a7[i]);
        for(let i1 = 0; i1 < toCleanup.length; i1++)toCleanup[i1].destroy();
    }
}
$69e1433b5e49874b$export$22044c20eef36040('SargassoSupervisor', $ccd81a49f0a7581e$export$26b75d03ac531c24);
...
function $f6533fdb015b2a84$var$remove(name, attributes) {
    $f6533fdb015b2a84$var$set(name, '', $f6533fdb015b2a84$var$__assign($f6533fdb015b2a84$var$__assign({
    }, attributes), {
        expires: -1
    }));
}
...
const $ae88abe471ad7ad7$export$f86ec3d89f756a21 = [
    {
        className: 'screen-xs',
        maxWidth: 599
    },
...
class $ae88abe471ad7ad7$export$c38d2c1bff643203 extends $69e1433b5e49874b$export$d7944a94c1afb262 {
    constructor(element, options = {
    }){
        options.watchResize = true;
        super(element, options);
        if (options.widths) this.options.widths = options.widths;
        else this.options.widths = $ae88abe471ad7ad7$export$f86ec3d89f756a21;
    ...
    disableResponsive(scale) {
        $32a536c4ebfbd5e9$export$6f53260fffa88f1c.addClass(document.body, 'disable-responsive');
        this.disabled = true;
        this.forceScale = scale;
        this.detectGeometry();
    }
    enableResponsive() {
        $32a536c4ebfbd5e9$export$6f53260fffa88f1c.removeClass(document.body, 'disable-responsive');
        this.disabled = false;
        this.forceScale = '';
        this.detectGeometry();
    }
        ...
        if (this.disabled) newScale = this.forceScale;
            ...
            if (wh > ww) {
                if (this.orientation !== 'portrait') {
                    const frame = ()=>{
                        $32a536c4ebfbd5e9$export$6f53260fffa88f1c.removeClass(document.body, 'landscape');
                        $32a536c4ebfbd5e9$export$6f53260fffa88f1c.addClass(document.body, 'portrait');
                    };
                    this.queueFrame(frame);
                ...
                const frame = ()=>{
                    $32a536c4ebfbd5e9$export$6f53260fffa88f1c.removeClass(document.body, 'portrait');
                    $32a536c4ebfbd5e9$export$6f53260fffa88f1c.addClass(document.body, 'landscape');
                };
                this.queueFrame(frame);
        ...
        if (newScale !== this.scale) {
            ...
            const frame = ()=>{
                for(let i = 0; i < this.classes.length; i++)if (this.classes[i] !== newScale) {
                    $32a536c4ebfbd5e9$export$6f53260fffa88f1c.addClass(document.body, 'not-' + this.classes[i]);
                    $32a536c4ebfbd5e9$export$6f53260fffa88f1c.removeClass(document.body, this.classes[i]);
                    $32a536c4ebfbd5e9$export$6f53260fffa88f1c.removeClass(document.body, 'shown-' + this.classes[i]);
                    $32a536c4ebfbd5e9$export$6f53260fffa88f1c.removeClass(document.body, 'hidden-' + this.classes[i]);
                } else $32a536c4ebfbd5e9$export$6f53260fffa88f1c.removeClass(document.body, 'not-' + this.classes[i]);
                $32a536c4ebfbd5e9$export$6f53260fffa88f1c.addClass(document.body, newScale);
                $32a536c4ebfbd5e9$export$6f53260fffa88f1c.addClass(document.body, 'shown-' + newScale);
                $32a536c4ebfbd5e9$export$6f53260fffa88f1c.addClass(document.body, 'hidden-' + newScale);
...
$69e1433b5e49874b$export$22044c20eef36040('Breakpoints', $ae88abe471ad7ad7$export$c38d2c1bff643203);





class $ea98180952248fa6$export$8c08cf4432b2f5b3 extends $69e1433b5e49874b$export$d7944a94c1afb262 {
    constructor(element, options = {
    }){
        options.watchDOM = true;
        options.immortal = true;
    ...
    loadPage(url) {
        const frame1 = ()=>{
            $32a536c4ebfbd5e9$export$6f53260fffa88f1c.addClass(document.body, 'hijax-loading');
        };
        ...
        xhr.onload = ()=>{
            if (xhr.status === 301 || xhr.status === 302 || xhr.getResponseHeader('Sargasso-Location')) {
                ...
                $b46dd4a3ae89fa2b$export$c7320459fd5267c0.scrollTop(0);
                ...
                const frame = ()=>{
                    ...
                    $32a536c4ebfbd5e9$export$6f53260fffa88f1c.removeClass(document.body, 'hijax-loading');
                };
                this.queueFrame(frame);
                this.currentPage = location.pathname + location.search;
            } else {
    ...
    mergePage(html) {
        ...
        const fragment = $ea98180952248fa6$var$makeFragment(doc[2]);
...
$69e1433b5e49874b$export$22044c20eef36040('HijaxLoader', $ea98180952248fa6$export$8c08cf4432b2f5b3);
// shims for borked browsers
// =========================
const $ea98180952248fa6$var$makeFragment = (html)=>{
...
let $51e3756202a07983$export$7869d9d42a3fc8a6;
const $51e3756202a07983$export$80ed8a0252d89225 = (options = {
})=>{
    if (options.scrollElement) $b46dd4a3ae89fa2b$export$c7320459fd5267c0.setOptions(options);
    if (options.breakpoints) {
        const breakpoints = new $ae88abe471ad7ad7$export$c38d2c1bff643203(document.body, options.breakpoints);
        breakpoints.start();
    }
    if (options.hijax) {
        const hijax = new $ea98180952248fa6$export$8c08cf4432b2f5b3(document.body, options.hijax);
        hijax.start();
        $51e3756202a07983$export$7869d9d42a3fc8a6 = hijax.setPage.bind(hijax);
    } else $51e3756202a07983$export$7869d9d42a3fc8a6 = (url)=>{
        document.location.href = url;
    };
    const supervisor = new $ccd81a49f0a7581e$export$26b75d03ac531c24(document.body, options);
...
const $c7e7b24eec642c61$export$eab97d15b1788b8d = {
    registerSargassoClass: $69e1433b5e49874b$export$22044c20eef36040,
    bootSargasso: $51e3756202a07983$export$80ed8a0252d89225,
    elementTools: $32a536c4ebfbd5e9$export$6f53260fffa88f1c,
    validate: $fc459ab49b48f320$export$a22775fa5e2eebd9,
    setValidator: $fc459ab49b48f320$export$636d763ed7be9e97
};
const $c7e7b24eec642c61$export$bce7a36871692cab = {
    theDOMWatcher: $b46dd4a3ae89fa2b$export$77e1d49fdb880d27,
    theScrollWatcher: $b46dd4a3ae89fa2b$export$c7320459fd5267c0,
    theResizeWatcher: $b46dd4a3ae89fa2b$export$497098c8185e6e33,
    theOrientationWatcher: $b46dd4a3ae89fa2b$export$296acd8d6f329fa3,
    theWorkerWatcher: $b46dd4a3ae89fa2b$export$fa28dfcc49831a91,
    theObservableObjectWatcher: $b46dd4a3ae89fa2b$export$788f7857dc8c77f5
};


export {$c7e7b24eec642c61$export$eab97d15b1788b8d as utils, $c7e7b24eec642c61$export$bce7a36871692cab as services, $69e1433b5e49874b$export$d7944a94c1afb262 as Sargasso, $51e3756202a07983$export$7869d9d42a3fc8a6 as loadPageHandler, $a4ae693d0e2d1ecb$export$b176171395436676 as ObservableObject};
